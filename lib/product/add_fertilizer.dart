...
class AddFertilizer extends StatefulWidget {
  ...
  @override
  State<AddFertilizer> createState() => _AddFertilizerState();
}
            ...
            child: StreamBuilder(
                ...
                builder: (context, AsyncSnapshot snapshot) {
                  return !isLoading ? ElevatedButton(
                    onPressed: () async {
                      CollectionReference farmProduct = FirebaseFirestore.instance.collection("Fertilizers");
                      if(_image == null) {
                        ...
                        firebase_storage.Reference storageRef = firebase_storage.FirebaseStorage.instance.ref("/fertilizers/$productNameController${DateTime.now()}");
                        ...
                        farmProduct.add({
                          'productType': 'Fertilizers'.toString(),
